...
import com.project.webIT.models.Status.CompanyFeedbackStatus;
...
public class CompanyFeedbackService implements com.project.webIT.services.IService.CompanyFeedbackService {
    ...
    public CompanyFeedback createCompanyFeedback(CompanyFeedbackDTO companyFeedbackDTO) throws Exception {
        ...
        if (!companyFeedback.getStatus().equalsIgnoreCase(CompanyFeedbackStatus.PASS)
        && !companyFeedback.getStatus().equalsIgnoreCase(CompanyFeedbackStatus.FAIL)){
